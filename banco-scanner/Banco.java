public class Banco{
    ...
    public boolean mesmoNumero(Conta conta, String numero){
    ...
    private boolean existeContaVersao2(String numero){
        return buscarConta(numero) != null;
        /*if (buscarConta(numero) != null){return true;} return false;*/
    }
    ...
    public double getSaldoMedio() {
        ...
        /*if (getQuantidadeContas() != 0){double saldoMedio = getPatrimonioLiquido() / getQuantidadeContas(); return saldoMedio;} return 0.0;*/
    }
